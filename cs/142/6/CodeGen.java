...
public class CodeGen {
    ...
    public void jumpAndLink (int label)
    {
        codeSeg.add ("jal L" + label);
    }
    ...
    public void loadValueIndirectly (int register0, int register1)
    {
        codeSeg.add ("lw $t" + register0 + ", ($t" + register1 + ")");
    }
    ...
    public void storeValueIndirectly (int register0, int register1)
    {
        codeSeg.add ("sw $t" + register0 + ", ($t" + register1 + ")");
    }
    ...
    public void globalAddressToRegister (int registerS, int address)
    {
        codeSeg.add ("add $t" + registerS + ", $gp, " + address);
    }
    ...
    public void constMultiply (int registerS, int register0, int constant)
    {
        codeSeg.add ("mul $t" + registerS + ", $t" + register0 + ", " + constant);
    }
    ...
    public void loadReturnValue (int register)
    {
        codeSeg.add ("move $t" + register + ", $v0");
    }

    public void storeReturnValue (int register)
    {
        codeSeg.add ("move $v0, $t" + register);
    }

    public void loadArgument (int register0, int register1)
    {
        codeSeg.add ("move $t"+ register0 + ", $a" + register1);
    }

    public void storeArgument (int register0, int register1)
    {
        codeSeg.add ("move $a"+ register1 + ", $t" + register0);
    }

    private void push (String register)
    {
        codeSeg.add ("add $sp, $sp, -4");
        codeSeg.add ("sw " + register + ", ($sp)");
    }
    ...
    public void pushTemporaryRegisters ()
    {
        for (int i = 0; i < 8; ++ i)
            push (i);
        for (int i = 0; i < 4; ++ i)
    ...
    public void popTemporaryRegisters ()
    {
        //        pop ("$ra");
        for (int i = 3; i >= 0; -- i)
            pop ("$a" + i);
