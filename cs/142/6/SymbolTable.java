...
public class SymbolTable extends LinkedList <SymbolTable.Entry <String, SymbolTable.Symbol>>
{
    ...
    public static interface TypeDesignator
    {
        ...
        public class Named implements TypeDesignator
        {
            ...
            public int dataSize () { return baseType.dataSize (); }
        }
        ...
        public class Array implements TypeDesignator
        {
            ...
            public int dataSize () { return baseType.dataSize () * length; }
        }
    ...
    public interface Symbol
    {
        ...
        abstract class SimplyTyped implements Symbol
        {
            ...
            public static class Procedure extends SimplyTyped
            {
                ...
                Procedure (TypeDesignator t, SymbolTable parent, int l)
                {
                    super (t);
            ...
            public static class Variable extends SimplyTyped
            {
                ...
                public int offset;
                boolean reference, register;

                Variable (TypeDesignator t, int o, boolean rf, boolean rg)
                {
                    super (t);
                    offset = o;
                    reference = rf;
                ...
                public void loadValueIntoRegister (CodeGen codeGen, int registe)
                {
                    if (register)
                        codeGen.loadArgument (registe, offset);
                    else
                        codeGen.loadValue (registe, offset);
                }
