...
public final class EBNF
{
    ...
    private static final Parseable
	  type                  = named ("type"                 , conjunct (terminal (IDENT), terminal (INT), terminal (SHORT)))
    ...
    public  static final Parseable
	  program               = named ("program"              , concat (declarations, procedureDeclarations, terminal (MAIN), terminal (OPEN_PAREN), terminal (CLOSE_PAREN), terminal (OPEN_BRACE), declarations, statementSequence, terminal (CLOSE_BRACE)));
